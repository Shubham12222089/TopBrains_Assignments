...
namespace CityMart.API.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        /// <summary>
        /// Checkout: Convert cart to order - Requires authentication
        /// </summary>
        [HttpPost("checkout")]
        [Authorize]
        public async Task<ActionResult<OrderDto>> Checkout()
        {
            try
            {
                ...
                return CreatedAtAction(nameof(GetOrder), new { id = order.Id }, new { success = true, message = "Order created successfully", data = order });
            }
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, new { success = false, message = "Error processing checkout" });
            }
        }
    }
}
